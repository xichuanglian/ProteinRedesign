...
public class MSAStar {
	 ...
	 * 		reduced size
	 */
	public MSAStar (int treeLevels, int numRotForRes[], ReducedEnergyMatrix arpMatrixRed, StericCheck stF, boolean[][] spFlags,
...
// ===================================================================================================
		//
		// modified by Wang Guosai 2013.6.25

		String tableName = "energy table";
		String vectorName = "rotamer table";
		...
		// open the file
		try {
			// fw = new FileWriter(pdbName);
			// out = new BufferedWriter(fw);
			pw1 = new PrintWriter(tableName);
			pw2 = new PrintWriter(vectorName);
        ...
        pw1.print(pairwiseMinEnergyMatrix.numTotalNodes + "\n");
		for (int i = 0; i < pairwiseMinEnergyMatrix.numTotalNodes + 1; i++) {
            // pw1.print(pairwiseMinEnergyMatrix.numTotalNodes + ": ");
			for (int j = 0; j < pairwiseMinEnergyMatrix.numTotalNodes + 1; j++) {
				pw1.print(pairwiseMinEnergyMatrix.getPairwiseE(i, j) + " ");
			}
			pw1.print('\n');
		}

		pw2.print(numTreeLevels + "\n");
		for (int i = 0; i < numTreeLevels; i++) {
			pw2.print(numRotForRes[i] + "\n");
		}
